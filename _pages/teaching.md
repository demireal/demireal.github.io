...
<section class="section">
  <h2 class="section__heading">MIT</h2>

  <div class="teaching-course">
    <h3 class="teaching-course__title">
      <a href="https://mlhcmit.github.io" target="_blank" rel="noopener">6.7930 / HST.956: Machine Learning for Healthcare</a>
    </h3>
    <p class="teaching-course__meta">Spring 2025 &middot; Teaching Assistant &middot; with Prof. David Sontag &amp; Prof. Peter Szolovits</p>
...
<section class="section">
  <h2 class="section__heading">Bilkent University</h2>

  <div class="teaching-course">
    <h3 class="teaching-course__title">
      <a href="https://catalog.bilkent.edu.tr/course/c14585.html" target="_blank" rel="noopener">EEE 485/585: Statistical Learning and Data Analytics</a>
    </h3>
    <p class="teaching-course__meta">Spring 2022 &middot; Teaching Assistant</p>
  </div>

  <div class="teaching-course">
    <h3 class="teaching-course__title">
      <a href="https://catalog.bilkent.edu.tr/course/c14212.html" target="_blank" rel="noopener">EEE 212: Microcontrollers and Embedded Systems</a>
    </h3>
    <p class="teaching-course__meta">Fall 2020/21, Spring 2021 &middot; Teaching Assistant</p>
  </div>
</section>
